...
data = []
with open("prepared_data/train_data.csv") as f:
...
data = []
with open("prepared_data/train_data_neg.csv") as f:
    for str in f:
        str = str.replace('"', '')
        str = str[:-2]
...
data = []
with open("prepared_data/train_data_all.csv") as f:
    for str in f:
        str = str.replace('"', '')
        str = str[:-2]
        data.append([float(idx) for idx in str.split(',')])
...
for i in range(len(ANN)):
    ...
    if res >= 0.8:
        ...
        b = b + 1
print()
print("number of probable Type 6 Effector is: ", a)
print("number of nonType 6 Effector is: ", b)
print(len(ANN))